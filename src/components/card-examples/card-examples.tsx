    ...
    return(
        <div className='flex flex-row gap-8 justify-center items-center pt-30 pb-15 px-15'>
            <Card
                hoverable
                style={{ width: 426}}
                cover={<img alt="img" src="/images/startup-3267505_640.jpg" />}
                > 
            ...
            <Card
                hoverable
                style={{ width: 426}}
                cover={<img alt="img" src="/images/code-820275_640.jpg" />}
                > 
            ...
            <Card
                hoverable
                style={{ width: 426 }}
                cover={<img alt="img" src="/images/man-791049_640.jpg" />}
                > 
            ...
            <Card
                hoverable
                style={{ width: 426}}
                cover={<img alt="img" src="/images/stock-trading-6525081_640.jpg" />}
                > 
            ...
            <Card
                hoverable
                style={{ width: 426}}
                cover={<img alt="img" src="/images/seychelles-4916045_640.jpg" />}
                > 
